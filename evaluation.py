...
if __name__ == "__main__":
    ...
    agent = load_transductive_agent()               # Non-inductive model
    # agent = load_naive_inductive_agent()          # Simple inductive model
    # agent = load_global_attn_inductive_agent()    # Self-attn Inductive model
